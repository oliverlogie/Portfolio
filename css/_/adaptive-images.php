...
$resolutions   = array(2200, 1200, 992, 768, 480); // the resolution break-points to use (screen widths, in pixels)
$cache_path    = (strpos($_SERVER['SERVER_NAME'], 'dev.q2e.at') !== false) ? (str_replace($_SERVER['DOCUMENT_ROOT'], '', __DIR__) . "/img/ai-cache") : "img/ai-cache"; // where to store the generated re-sized images. Specify from your document root!
