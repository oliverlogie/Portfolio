<?php
  ...
  "m_mode_name_mod_leaguemanagerteam" => "Basketballmanager - Team administration",
  ...
  "lt_function_edit_label2" => "Edit data of the selected team",
  "lt_function_list_label" => "List of teams",
  "lt_function_list_label2" => "Created teams",
  "lt_list_image_label" => "Emblem",
  "lt_list_team_label" => "Team",
  "lt_list_location_label" => "Stadium",
  "lt_name_label" => "Name",
  "lt_shortname_label" => "Short name",
  "lt_location_label" => "Name of the stadium",
  "lt_image_label" => "Emblem",
  "lt_data_label" => "Data of the team",
  "lt_content_label" => "Modify team",
  ...
  "lt_message_edititem_success" => "Team has been modified",
  "lt_message_deleteitem_success" => "Team has been deleted",
  "lt_message_insufficient_input" => "Please at least enter the name and the nickname of the team!",
