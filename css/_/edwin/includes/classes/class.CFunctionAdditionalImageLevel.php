...
/**
 * Objects of CFunctionAdditionalImageLevel class handle the 'additionalimagelevel'
 * core function / module features.
 *
 * The 'additionalimagelevel' feature allows defining certain level items, which
 * allows the user to provide an additional image for contentitems inside this
 * level.
 *
 ...
 */
class CFunctionAdditionalImageLevel extends AbstractCFunction
{
  public function getShortname()
  {
    return 'additionalimagelevel';
  }
  ...
  public function isAvailableOnPage(NavigationPage $page)
  {
    ...
    $config = ConfigHelper::get('m_additionalimagelevel_level', '',
        $page->getSite()->getID());
